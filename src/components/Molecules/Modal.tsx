...
const Modal = ({ title, children, isOpen, onClose }: ModalProps) => {
  return (
    <section
      className={`fixed inset-0 m-2 flex flex-col items-center duration-300 justify-start mt-10  ${
    ...
    >
      ...
      />
      <main className="max-w-screen-lg overflow-auto w-11/12 sm:w-full p-6 bg-neutral-100 text-neutral-800 rounded-md shadow-md shadow-neutral-800 z-50">
